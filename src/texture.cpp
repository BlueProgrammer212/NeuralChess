...
void TextureManager::RenderTexture(int target_square, int type)
 {
    ...
    SDL_Rect src = {final_type * m_source_width, color * m_source_height, m_source_width, m_source_height};
    SDL_Rect dest = {pos.x * Globals::BOX_WIDTH, pos.y * Globals::BOX_HEIGHT, Globals::BOX_WIDTH, Globals::BOX_HEIGHT};
